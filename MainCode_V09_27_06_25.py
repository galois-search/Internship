...
def main(input_file_path,input_file_name):
    ...
    file_name = f"{OG_file_name}_unique_before_decimation.txt"
    output_folder_before_dec = f"m{m}_Unique_before_decimation"
    ...
    file_name = f"{OG_file_name}_decimated_sequences.txt"
    output_folder_decimation = f"m{m}_Decimated_sequences"
    ...
    file_name = f"{OG_file_name}_unique_after_decimation.txt"
    output_folder_after_dec = f"m{m}_Unique_after_decimation"
