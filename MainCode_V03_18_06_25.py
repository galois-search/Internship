...
if __name__ == "__main__":
    ...
    input_file = "m8_unique_period_14.txt"
    input_acr_value = 7
    ...
    for item in result:
        ...
        list_of_sequence = Decimation.generate_sequences_from_sequence_v2(binary_sequence)
        print(resultVal)
        print(list_of_sequence)
        Algorithm2.find_unique_sequences_v3(list_of_sequence,params,period,acr_val,balance_val,input_file)
